...
<div class="navbar navbar-default" id="subnav">
	<div class="col-md-12">
		<div class="navbar-header">
			<a href="/index.jsp" style="margin-left:15px;" class="navbar-btn btn btn-default btn-plus dropdown-toggle" data-toggle="dropdown">
		...
		<div class="collapse navbar-collapse" id="navbar-collapse2">
			<ul class="nav navbar-nav navbar-right">
				...
				<c:choose>
					...
					<c:otherwise>
						<li><a href="/user/logout.jsp" role="button">로그아웃</a></li>
						<li><a href="/user/updateForm?userId=${sessionScope.loginId}" role="button">개인정보수정</a></li>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>
