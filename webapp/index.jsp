						...
						<div class="wrap">
							<div class="main">
								<strong class="subject">
									<a href="/qna/show?questionId=${qna.questionId}">${qna.title}</a>
								</strong>
								<div class="auth-info">
									<i class="icon-add-comment"></i>
									<span class="time">${qna.createdDate}</span>
									<a href="/user/profile.html" class="author">${qna.writer}</a>
								</div>
								<div class="reply" title="댓글">
									<i class="icon-reply"></i>
									<span class="point">${qna.countOfAnswer}</span>
								</div>
							</div>
						</div>
					</li>
